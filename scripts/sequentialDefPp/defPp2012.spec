...
l2Reg: 0.00005
modelQuery: SELECT %s FROM %s WHERE bucket < 10 AND year(month) < 2012
validateQuery: SELECT %s FROM %s WHERE bucket in (10,11,12,13,14) AND year(month) < 2012
assessQuery: SELECT %s FROM %s WHERE bucket in (15,16,17,18,19)

// output locations
outDir: /home/will/goMortgage/sequential/defPp/dq2012
...
inputModel: mod
modLocation: /home/will/goMortgage/sequential/mod/mod2012
modTargets: pModDirect:1

inputModel: dq
dqLocation: /home/will/goMortgage/sequential/dq/dq2012
